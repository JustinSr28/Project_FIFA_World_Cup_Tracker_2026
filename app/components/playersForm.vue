...
<template>
    <form @submit.prevent="enviarFormulario" class="team-form">
        ...
        <div class="form-grupo">
            ...
            <input v-model="formulario.name" :class="{ 'input-error': errores.name }" type="text" placeholder="Ej: Kylian Mbappé">
            <span v-if="errores.name" class="error"> {{ errores.name }} </span>
        </div>

        <div class="form-grupo">
            <label>Club</label>
            <input v-model="formulario.club" :class="{ 'input-error': errores.club }" type="text" placeholder="Ej: Real Madrid">
            <span v-if="errores.club" class="error">{{ errores.club }}</span>
        </div>
        ...
        <div class="form-grupo">
            ...
            <select v-model="formulario.position" :class="{ 'input-error': errores.position }">
            ...
            <span v-if="errores.position" class="error">{{ errores.position }}</span>
        </div>
        ...
        <div class="form-grupo">
            ...
            <select v-model="formulario.teamId" :class="{ 'input-error': errores.teamId }">
